...
int lttng_track_pid(struct lttng_handle *handle, int pid)
{
	...
	handle_status = lttng_process_attr_virtual_process_id_tracker_handle_add_pid(
...
int lttng_untrack_pid(struct lttng_handle *handle, int pid)
{
	...
	handle_status = lttng_process_attr_virtual_process_id_tracker_handle_remove_pid(
			tracker_handle, (pid_t) pid);
